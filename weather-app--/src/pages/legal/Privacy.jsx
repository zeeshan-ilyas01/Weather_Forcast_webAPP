  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: layout.maxWidth, margin: "0 auto", padding: "40px 20px", color: colors.cream, fontFamily: fonts.display }}>
        ...
        <h1 style={{ fontFamily: "'Fraunces', serif", marginTop: 20 }}>Privacy Policy</h1>
        <p style={{ opacity: 0.8, fontStyle: "italic" }}>Last updated: [add today's date when you publish this]</p>

        <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 20, marginTop: 32 }}>What data this site collects</h2>
        ...
        <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 20, marginTop: 32 }}>Cookies and advertising</h2>
        <p style={{ opacity: 0.9, lineHeight: 1.6 }}>
        ...
        <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 20, marginTop: 32 }}>Third-party services used</h2>
        ...
        <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 20, marginTop: 32 }}>Contact</h2>
        <p style={{ opacity: 0.9, lineHeight: 1.6 }}>
