  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: layout.maxWidth, margin: "0 auto", padding: "40px 20px", color: colors.cream, fontFamily: fonts.body }}>
        ...
        <h2 style={{ fontFamily: fonts.display, fontSize: 20, marginTop: 32 }}>No warranty</h2>
        <p style={{ opacity: 0.9, lineHeight: 1.6 }}>
        ...
        <h2 style={{ fontFamily: fonts.display, fontSize: 20, marginTop: 32 }}>Changes to these terms</h2>
        <p style={{ opacity: 0.9, lineHeight: 1.6 }}>
